...
const clientPrivateNotes = require('./routes/clientPrivateNotesRoutes.js');
const clientDeletion = require('./routes/clientDeletionRoutes.js');
const cobiCheckout = require('./routes/cobiCheckoutRoutes.js');
const calendarEvents = require('./routes/calendarEventsRoutes.js');
const community = require('./routes/communityRoutes.js');
const coachCommunity = require('./routes/coachCommunityRoutes.js');
const flexAssistant = require('./routes/flexRoutes.js');
const membership = require('./routes/membershipRoutes.js');
const googleAuth = require('./routes/googleAuthRoutes.js');
const inviteRoutes = require('./routes/inviteRoutes.js');
const trainerModulesRoutes = require('./routes/trainerModulesRoutes.js');
const myRoutinesRoutes = require('./routes/myRoutinesRoutes.js');
const photoGalleryRoutes = require('./routes/photoGalleryRoutes.js');
const nutritionCatalogRoutes = require('./routes/nutritionCatalogRoutes.js');
const giveaways = require('./routes/giveawayRoutes.js');
...
const emoonUserPackagesRoutes = require('./routes/emoonUserPackagesRoutes')
const emoonCategoriesRoutes = require('./routes/emoonCategoriesRoutes.js');
const emoonPaymentsRoutes = require('./routes/emoonPaymentsRoutes.js');
...
googleAuth(app);
inviteRoutes(app);
trainerModulesRoutes(app, upload);
myRoutinesRoutes(app);
photoGalleryRoutes(app, upload);
nutritionCatalogRoutes(app, upload);
...
emoonUserPackagesRoutes(app);
emoonCategoriesRoutes(app);
emoonPaymentsRoutes(app);
/**
 * =========================================================
