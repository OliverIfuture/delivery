...
*/
    ...
    app.get('/api/orders/findByClientDealerRechargeGym/:id_sucursal', passport.authenticate('dealer-jwt', { session: false }), ordersController.findByClientDealerRechargeGym);
