...
*/
    ...
    app.get('/api/orders/findByClientDealerRechargeGym/:id_client', passport.authenticate('dealer-jwt', { session: false }), ordersController.findByClientDealerRechargeGym);
