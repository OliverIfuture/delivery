...
module.exports = (app, upload) => {
  ...
  app.post('/api/products/createPost', upload.array('image', 1), productsControllers.createPost); app.post('/api/products/create', passport.authenticate('jwt', { session: false }), upload.array('image', 3), productsControllers.create);
  ...
  app.get('/api/products/getAllServices/:id', productsControllers.getAllServices);
  app.get('/api/products/getSchedulesAvailable/:id/:day', productsControllers.getSchedulesAvailable);

  app.get('/api/products/populars', productsControllers.populars);
  app.get('/api/products/selectFlores', productsControllers.selectFlores);
  app.get('/api/products/selectSizes', productsControllers.selectSizes);
  ...
  app.get('/api/products/getAllStocks/:id_company/:id_company_product', passport.authenticate('jwt', { session: false }), productsControllers.getAllStocks);
  ...
  app.get('/api/products/findByCategoryAndProductNameStocksNewApp/:id_category/:product_name/:id_company', passport.authenticate('jwt', { session: false }), productsControllers.findByCategoryAndProductNameStocksNewApp);
