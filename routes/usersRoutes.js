...
module.exports = (app, upload) => {
    ...
    app.get('/api/users/findByUserIdPhone/:id', passport.authenticate('jwt', { session: false }), UsersController.findByUserIdPhone);
    ...
    app.get('/cobi/api/users/findById/:id', passport.authenticate('cobi-jwt', { session: false }), UsersController.cobifindById);
