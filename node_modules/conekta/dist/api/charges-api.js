...
exports.UpdateChargeAcceptLanguageEnum = exports.OrdersCreateChargeAcceptLanguageEnum = exports.GetChargesAcceptLanguageEnum = exports.ChargesApi = exports.ChargesApiFactory = exports.ChargesApiFp = exports.ChargesApiAxiosParamCreator = void 0;
...
const ChargesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        getCharges: (acceptLanguage, xChildCompanyId, limit, search, next, previous, options = {}) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @throws {RequiredError}
         */
        ordersCreateCharge: (id, chargeRequest, acceptLanguage, xChildCompanyId, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('ordersCreateCharge', 'id', id);
            // verify required parameter 'chargeRequest' is not null or undefined
            (0, common_1.assertParamExists)('ordersCreateCharge', 'chargeRequest', chargeRequest);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(chargeRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
         ...
         * @throws {RequiredError}
         */
        updateCharge: (id, chargeUpdateRequest, acceptLanguage, xChildCompanyId, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('updateCharge', 'id', id);
            // verify required parameter 'chargeUpdateRequest' is not null or undefined
            (0, common_1.assertParamExists)('updateCharge', 'chargeUpdateRequest', chargeUpdateRequest);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(chargeUpdateRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
    ...
    return {
        ...
        getCharges(acceptLanguage, xChildCompanyId, limit, search, next, previous, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const operationBasePath = (_c = (_b = base_1.operationServerMap['ChargesApi.getCharges']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
        ...
        ordersCreateCharge(id, chargeRequest, acceptLanguage, xChildCompanyId, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = base_1.operationServerMap['ChargesApi.ordersCreateCharge']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
        /**
        ...
        updateCharge(id, chargeUpdateRequest, acceptLanguage, xChildCompanyId, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = base_1.operationServerMap['ChargesApi.updateCharge']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
    };
...
class ChargesApi extends base_1.BaseAPI {
     ...
     */
    getCharges(acceptLanguage, xChildCompanyId, limit, search, next, previous, options) {
        return (0, exports.ChargesApiFp)(this.configuration).getCharges(acceptLanguage, xChildCompanyId, limit, search, next, previous, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Create charge for an existing orden
     * @summary Create charge
     ...
     */
    ordersCreateCharge(id, chargeRequest, acceptLanguage, xChildCompanyId, options) {
        return (0, exports.ChargesApiFp)(this.configuration).ordersCreateCharge(id, chargeRequest, acceptLanguage, xChildCompanyId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Update a charge
     ...
     */
    updateCharge(id, chargeUpdateRequest, acceptLanguage, xChildCompanyId, options) {
        return (0, exports.ChargesApiFp)(this.configuration).updateCharge(id, chargeUpdateRequest, acceptLanguage, xChildCompanyId, options).then((request) => request(this.axios, this.basePath));
    }
}
 ...
 * @export
 */
exports.GetChargesAcceptLanguageEnum = {
    es: 'es',
    en: 'en'
};
/**
 ...
 * @export
 */
exports.UpdateChargeAcceptLanguageEnum = {
    es: 'es',
    en: 'en'
};
