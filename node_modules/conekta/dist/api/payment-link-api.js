...
exports.SmsCheckoutAcceptLanguageEnum = exports.GetCheckoutsAcceptLanguageEnum = exports.GetCheckoutAcceptLanguageEnum = exports.EmailCheckoutAcceptLanguageEnum = exports.CreateCheckoutAcceptLanguageEnum = exports.CancelCheckoutAcceptLanguageEnum = exports.PaymentLinkApi = exports.PaymentLinkApiFactory = exports.PaymentLinkApiFp = exports.PaymentLinkApiAxiosParamCreator = void 0;
 ...
 * @export
 */
const PaymentLinkApiAxiosParamCreator = function (configuration) {
    return {
        /**
         *
        ...
        cancelCheckout: (id, acceptLanguage, xChildCompanyId, options = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            (0, common_1.assertParamExists)('cancelCheckout', 'id', id);
        ...
        createCheckout: (checkout, acceptLanguage, xChildCompanyId, options = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            (0, common_1.assertParamExists)('createCheckout', 'checkout', checkout);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(checkout, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        emailCheckout: (id, emailCheckoutRequest, acceptLanguage, xChildCompanyId, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('emailCheckout', 'id', id);
            // verify required parameter 'emailCheckoutRequest' is not null or undefined
            (0, common_1.assertParamExists)('emailCheckout', 'emailCheckoutRequest', emailCheckoutRequest);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(emailCheckoutRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        getCheckout: (id, acceptLanguage, xChildCompanyId, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getCheckout', 'id', id);
        ...
        smsCheckout: (id, smsCheckoutRequest, acceptLanguage, xChildCompanyId, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('smsCheckout', 'id', id);
            // verify required parameter 'smsCheckoutRequest' is not null or undefined
            (0, common_1.assertParamExists)('smsCheckout', 'smsCheckoutRequest', smsCheckoutRequest);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(smsCheckoutRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
...
exports.PaymentLinkApiAxiosParamCreator = PaymentLinkApiAxiosParamCreator;
/**
 * PaymentLinkApi - functional programming interface
 * @export
 */
const PaymentLinkApiFp = function (configuration) {
    const localVarAxiosParamCreator = (0, exports.PaymentLinkApiAxiosParamCreator)(configuration);
    return {
        /**
         *
         * @summary Cancel Payment Link
        ...
        cancelCheckout(id, acceptLanguage, xChildCompanyId, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const operationBasePath = (_c = (_b = base_1.operationServerMap['PaymentLinkApi.cancelCheckout']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
        ...
        createCheckout(checkout, acceptLanguage, xChildCompanyId, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = base_1.operationServerMap['PaymentLinkApi.createCheckout']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
        /**
        ...
        emailCheckout(id, emailCheckoutRequest, acceptLanguage, xChildCompanyId, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = base_1.operationServerMap['PaymentLinkApi.emailCheckout']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
        /**
        ...
        getCheckout(id, acceptLanguage, xChildCompanyId, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = base_1.operationServerMap['PaymentLinkApi.getCheckout']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
        /**
        ...
        getCheckouts(acceptLanguage, xChildCompanyId, limit, search, next, previous, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = base_1.operationServerMap['PaymentLinkApi.getCheckouts']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
        /**
        ...
        smsCheckout(id, smsCheckoutRequest, acceptLanguage, xChildCompanyId, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = base_1.operationServerMap['PaymentLinkApi.smsCheckout']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
    };
};
exports.PaymentLinkApiFp = PaymentLinkApiFp;
/**
 * PaymentLinkApi - factory interface
 * @export
 */
const PaymentLinkApiFactory = function (configuration, basePath, axios) {
    const localVarFp = (0, exports.PaymentLinkApiFp)(configuration);
    return {
        /**
         *
         * @summary Cancel Payment Link
...
exports.PaymentLinkApiFactory = PaymentLinkApiFactory;
/**
 ...
 * @extends {BaseAPI}
 */
class PaymentLinkApi extends base_1.BaseAPI {
    /**
     *
     * @summary Cancel Payment Link
     * @param {string} id Identifier of the resource
     ...
     */
    cancelCheckout(id, acceptLanguage, xChildCompanyId, options) {
        return (0, exports.PaymentLinkApiFp)(this.configuration).cancelCheckout(id, acceptLanguage, xChildCompanyId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Create Unique Payment Link
     ...
     */
    createCheckout(checkout, acceptLanguage, xChildCompanyId, options) {
        return (0, exports.PaymentLinkApiFp)(this.configuration).createCheckout(checkout, acceptLanguage, xChildCompanyId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Send an email
     ...
     */
    emailCheckout(id, emailCheckoutRequest, acceptLanguage, xChildCompanyId, options) {
        return (0, exports.PaymentLinkApiFp)(this.configuration).emailCheckout(id, emailCheckoutRequest, acceptLanguage, xChildCompanyId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Get a payment link by ID
     ...
     */
    getCheckout(id, acceptLanguage, xChildCompanyId, options) {
        return (0, exports.PaymentLinkApiFp)(this.configuration).getCheckout(id, acceptLanguage, xChildCompanyId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Returns a list of links generated by the merchant
     * @summary Get a list of payment links
     ...
     */
    getCheckouts(acceptLanguage, xChildCompanyId, limit, search, next, previous, options) {
        return (0, exports.PaymentLinkApiFp)(this.configuration).getCheckouts(acceptLanguage, xChildCompanyId, limit, search, next, previous, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Send an sms
     ...
     */
    smsCheckout(id, smsCheckoutRequest, acceptLanguage, xChildCompanyId, options) {
        return (0, exports.PaymentLinkApiFp)(this.configuration).smsCheckout(id, smsCheckoutRequest, acceptLanguage, xChildCompanyId, options).then((request) => request(this.axios, this.basePath));
    }
}
 ...
 * @export
 */
exports.EmailCheckoutAcceptLanguageEnum = {
    es: 'es',
    en: 'en'
};
/**
 ...
 * @export
 */
exports.SmsCheckoutAcceptLanguageEnum = {
    es: 'es',
    en: 'en'
};
