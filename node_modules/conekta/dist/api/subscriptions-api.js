...
const SubscriptionsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        cancelSubscription: (id, acceptLanguage, xChildCompanyId, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('cancelSubscription', 'id', id);
         ...
         * @throws {RequiredError}
         */
        createSubscription: (id, subscriptionRequest, acceptLanguage, xChildCompanyId, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('createSubscription', 'id', id);
            // verify required parameter 'subscriptionRequest' is not null or undefined
            (0, common_1.assertParamExists)('createSubscription', 'subscriptionRequest', subscriptionRequest);
         ...
         * @throws {RequiredError}
         */
        getAllEventsFromSubscription: (id, acceptLanguage, xChildCompanyId, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('getAllEventsFromSubscription', 'id', id);
         ...
         * @throws {RequiredError}
         */
        getSubscription: (id, acceptLanguage, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        pauseSubscription: (id, acceptLanguage, xChildCompanyId, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('pauseSubscription', 'id', id);
         ...
         * @throws {RequiredError}
         */
        resumeSubscription: (id, acceptLanguage, xChildCompanyId, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            (0, common_1.assertParamExists)('resumeSubscription', 'id', id);
         ...
         * @throws {RequiredError}
         */
        updateSubscription: (id, subscriptionUpdateRequest, acceptLanguage, xChildCompanyId, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            ...
            (0, common_1.assertParamExists)('updateSubscription', 'subscriptionUpdateRequest', subscriptionUpdateRequest);
            const localVarPath = `/customers/{id}/subscription`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_1.DUMMY_BASE_URL);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(subscriptionUpdateRequest, localVarRequestOptions, configuration);
            return {
                url: (0, common_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
    ...
    return {
        ...
        cancelSubscription(id, acceptLanguage, xChildCompanyId, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const operationBasePath = (_c = (_b = base_1.operationServerMap['SubscriptionsApi.cancelSubscription']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
        ...
        createSubscription(id, subscriptionRequest, acceptLanguage, xChildCompanyId, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = base_1.operationServerMap['SubscriptionsApi.createSubscription']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
        /**
        ...
        getAllEventsFromSubscription(id, acceptLanguage, xChildCompanyId, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = base_1.operationServerMap['SubscriptionsApi.getAllEventsFromSubscription']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
        /**
        ...
        getSubscription(id, acceptLanguage, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = base_1.operationServerMap['SubscriptionsApi.getSubscription']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
        /**
        ...
        pauseSubscription(id, acceptLanguage, xChildCompanyId, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = base_1.operationServerMap['SubscriptionsApi.pauseSubscription']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
        /**
        ...
        resumeSubscription(id, acceptLanguage, xChildCompanyId, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = base_1.operationServerMap['SubscriptionsApi.resumeSubscription']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
        /**
        ...
        updateSubscription(id, subscriptionUpdateRequest, acceptLanguage, xChildCompanyId, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = base_1.operationServerMap['SubscriptionsApi.updateSubscription']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
    };
...
class SubscriptionsApi extends base_1.BaseAPI {
     ...
     */
    cancelSubscription(id, acceptLanguage, xChildCompanyId, options) {
        return (0, exports.SubscriptionsApiFp)(this.configuration).cancelSubscription(id, acceptLanguage, xChildCompanyId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * You can create the subscription to include the plans that your customers consume
     * @summary Create Subscription
     ...
     */
    createSubscription(id, subscriptionRequest, acceptLanguage, xChildCompanyId, options) {
        return (0, exports.SubscriptionsApiFp)(this.configuration).createSubscription(id, subscriptionRequest, acceptLanguage, xChildCompanyId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * You can get the events of the subscription(s) of a client, with the customer id
     * @summary Get Events By Subscription
     ...
     */
    getAllEventsFromSubscription(id, acceptLanguage, xChildCompanyId, options) {
        return (0, exports.SubscriptionsApiFp)(this.configuration).getAllEventsFromSubscription(id, acceptLanguage, xChildCompanyId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     *
     * @summary Get Subscription
     ...
     */
    getSubscription(id, acceptLanguage, options) {
        return (0, exports.SubscriptionsApiFp)(this.configuration).getSubscription(id, acceptLanguage, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * You can pause the subscription to stop the plans that your customers consume
     * @summary Pause Subscription
     ...
     */
    pauseSubscription(id, acceptLanguage, xChildCompanyId, options) {
        return (0, exports.SubscriptionsApiFp)(this.configuration).pauseSubscription(id, acceptLanguage, xChildCompanyId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * You can resume the subscription to start the plans that your customers consume
     * @summary Resume Subscription
     ...
     */
    resumeSubscription(id, acceptLanguage, xChildCompanyId, options) {
        return (0, exports.SubscriptionsApiFp)(this.configuration).resumeSubscription(id, acceptLanguage, xChildCompanyId, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * You can modify the subscription to change the plans that your customers consume
     * @summary Update Subscription
     ...
     */
    updateSubscription(id, subscriptionUpdateRequest, acceptLanguage, xChildCompanyId, options) {
        return (0, exports.SubscriptionsApiFp)(this.configuration).updateSubscription(id, subscriptionUpdateRequest, acceptLanguage, xChildCompanyId, options).then((request) => request(this.axios, this.basePath));
    }
}
