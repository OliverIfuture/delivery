...
exports.CreateTokenAcceptLanguageEnum = exports.TokensApi = exports.TokensApiFactory = exports.TokensApiFp = exports.TokensApiAxiosParamCreator = void 0;
...
const TokensApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        createToken: (token, acceptLanguage, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'token' is not null or undefined
            (0, common_1.assertParamExists)('createToken', 'token', token);
...
const TokensApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createToken(token, acceptLanguage, options) {
            var _a, _b, _c;
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.createToken(token, acceptLanguage, options);
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = base_1.operationServerMap['TokensApi.createToken']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
...
class TokensApi extends base_1.BaseAPI {
     ...
     */
    createToken(token, acceptLanguage, options) {
        return (0, exports.TokensApiFp)(this.configuration).createToken(token, acceptLanguage, options).then((request) => request(this.axios, this.basePath));
    }
}
