 ...
 * @export
 */
export const TransfersApiAxiosParamCreator = function (configuration) {
    return {
        /**
 ...
 * @export
 */
export const TransfersApiFp = function (configuration) {
    ...
    return {
        ...
        getTransfer(id, acceptLanguage, xChildCompanyId, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const operationBasePath = (_c = (_b = operationServerMap['TransfersApi.getTransfer']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
        ...
        getTransfers(acceptLanguage, xChildCompanyId, limit, search, next, previous, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = operationServerMap['TransfersApi.getTransfers']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
    };
 ...
 * @export
 */
export const TransfersApiFactory = function (configuration, basePath, axios) {
