...
export const ProductsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        ordersCreateProduct: (id, product, acceptLanguage, xChildCompanyId, options = {}) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @throws {RequiredError}
         */
        ordersDeleteProduct: (id, lineItemId, acceptLanguage, xChildCompanyId, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        ordersUpdateProduct: (id, lineItemId, updateProduct, acceptLanguage, xChildCompanyId, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
