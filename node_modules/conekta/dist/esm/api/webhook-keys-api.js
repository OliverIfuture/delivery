 ...
 * @export
 */
export const WebhookKeysApiAxiosParamCreator = function (configuration) {
    return {
        /**
         ...
         */
        createWebhookKey: (acceptLanguage, webhookKeyRequest, options = {}) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @throws {RequiredError}
         */
        deleteWebhookKey: (id, acceptLanguage, options = {}) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @throws {RequiredError}
         */
        getWebhookKey: (id, acceptLanguage, xChildCompanyId, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getWebhookKeys: (acceptLanguage, xChildCompanyId, limit, search, next, previous, options = {}) => __awaiter(this, void 0, void 0, function* () {
            const localVarPath = `/webhook_keys`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        updateWebhookKey: (id, acceptLanguage, webhookKeyUpdateRequest, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
 ...
 * @export
 */
export const WebhookKeysApiFp = function (configuration) {
    ...
    return {
        ...
        createWebhookKey(acceptLanguage, webhookKeyRequest, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const operationBasePath = (_c = (_b = operationServerMap['WebhookKeysApi.createWebhookKey']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
        ...
        deleteWebhookKey(id, acceptLanguage, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = operationServerMap['WebhookKeysApi.deleteWebhookKey']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
        /**
        ...
        getWebhookKey(id, acceptLanguage, xChildCompanyId, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = operationServerMap['WebhookKeysApi.getWebhookKey']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
        /**
        ...
        getWebhookKeys(acceptLanguage, xChildCompanyId, limit, search, next, previous, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = operationServerMap['WebhookKeysApi.getWebhookKeys']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
        /**
        ...
        updateWebhookKey(id, acceptLanguage, webhookKeyUpdateRequest, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = operationServerMap['WebhookKeysApi.updateWebhookKey']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
    };
 ...
 * @export
 */
export const WebhookKeysApiFactory = function (configuration, basePath, axios) {
 ...
 * @extends {BaseAPI}
 */
export class WebhookKeysApi extends BaseAPI {
    /**
     * Create a webhook key
     * @summary Create Webhook Key
     * @param {CreateWebhookKeyAcceptLanguageEnum} [acceptLanguage] Use for knowing which language to use
