...
export const OrdersApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        cancelOrder: (id, acceptLanguage, xChildCompanyId, options = {}) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @throws {RequiredError}
         */
        createOrder: (orderRequest, acceptLanguage, xChildCompanyId, options = {}) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @throws {RequiredError}
         */
        getOrderById: (id, acceptLanguage, xChildCompanyId, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getOrders: (acceptLanguage, xChildCompanyId, limit, search, next, previous, options = {}) => __awaiter(this, void 0, void 0, function* () {
            const localVarPath = `/orders`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        orderCancelRefund: (id, refundId, acceptLanguage, xChildCompanyId, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        orderRefund: (id, orderRefundRequest, acceptLanguage, xChildCompanyId, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        ordersCreateCapture: (id, acceptLanguage, xChildCompanyId, orderCaptureRequest, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        updateOrder: (id, orderUpdateRequest, acceptLanguage, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
