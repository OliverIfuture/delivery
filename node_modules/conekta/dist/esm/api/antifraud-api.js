 ...
 * @export
 */
export const AntifraudApiAxiosParamCreator = function (configuration) {
    return {
        /**
         *
 ...
 * @export
 */
export const AntifraudApiFp = function (configuration) {
    ...
    return {
        ...
        createRuleBlacklist(createRiskRulesData, acceptLanguage, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const operationBasePath = (_c = (_b = operationServerMap['AntifraudApi.createRuleBlacklist']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
        ...
        createRuleWhitelist(acceptLanguage, createRiskRulesData, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = operationServerMap['AntifraudApi.createRuleWhitelist']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
        /**
        ...
        deleteRuleBlacklist(id, acceptLanguage, xChildCompanyId, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = operationServerMap['AntifraudApi.deleteRuleBlacklist']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
        /**
        ...
        deleteRuleWhitelist(id, acceptLanguage, xChildCompanyId, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = operationServerMap['AntifraudApi.deleteRuleWhitelist']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
        /**
        ...
        getRuleBlacklist(acceptLanguage, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = operationServerMap['AntifraudApi.getRuleBlacklist']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
        /**
        ...
        getRuleWhitelist(acceptLanguage, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = operationServerMap['AntifraudApi.getRuleWhitelist']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
    };
 ...
 * @export
 */
export const AntifraudApiFactory = function (configuration, basePath, axios) {
