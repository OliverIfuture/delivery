...
export const TransactionsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        getTransaction: (id, acceptLanguage, xChildCompanyId, options = {}) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @throws {RequiredError}
         */
        getTransactions: (acceptLanguage, xChildCompanyId, limit, next, previous, id, chargeId, type, currency, options = {}) => __awaiter(this, void 0, void 0, function* () {
    ...
    return {
        ...
        getTransaction(id, acceptLanguage, xChildCompanyId, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const operationBasePath = (_c = (_b = operationServerMap['TransactionsApi.getTransaction']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
        ...
        getTransactions(acceptLanguage, xChildCompanyId, limit, next, previous, id, chargeId, type, currency, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                const operationBasePath = (_c = (_b = operationServerMap['TransactionsApi.getTransactions']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, operationBasePath || basePath);
            });
        },
    };
