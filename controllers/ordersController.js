    ...
    async createSale(req, res, next) {
        try {
            ...
            for (const product of sales.products) {
                ...
                await OrderHasProducts.createSale(product.name, product.price, product.image1, product.price_buy, sales.reference, product.quantity, sales.shift_ref, product.state);
