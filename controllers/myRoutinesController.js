...
module.exports = {
    ...
    // Todas las rutinas de CLIENTES de esta empresa (sin plantillas) — para
    // pintar el estatus real de cada cliente en la columna de "Mis Clientes"
    // sin un fetch por cliente.
